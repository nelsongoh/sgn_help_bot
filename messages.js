// This file contains all the messages as constants
module.exports = {
  PVT_MSG_OPT: "\n\nIf you would like to use this bot in your own chat, please search for, or tap on this link: @sgn_help_bot",
  ...
  FLT_STATUS_MSG: "Here are some links regarding the status of flights for the various airlines:\n\n" +
  
  "Singapore Airlines (Click on South West Pacific):\n" +
  "https://www.singaporeair.com/en_UK/sg/media-centre/news-alert/?id=jmjgoyqg\n\n" + 
  
  "Scoot:\n" +
  "https://www.flyscoot.com/en/announcements/temporary-flight-suspensions\n\n",

  /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */

  INFO_MSG: "Here are some links to help you get started:\n\n" +

  "A community-based wiki on Google Docs:\n" +
  ...
  CHAT_GRPS_MSG: "Here are a list of chat groups for your reference:\n\n" +

  "For Singaporeans in Western Australia:\n" +
  "https://t.me/singaporeansinwa\n\n" +
  
  "For Singaporeans in Sydney / New South Wales:\n" +
  "https://t.me/sydwhvsv\n\n" +
  
  "For Singaporeans in Victoria:\n" +
  "https://t.me/joinchat/N9XzVRWMzCM9yMuRB1E08w\n\n" +
  
  "For Singaporeans in Brisbane:\n" +
  "https://t.me/singaporeansinbrisbane\n\n" +
  
  "For Singaporeans in Tasmania:\n" +
  ...
  NOT_PERMITTED_MSG: "You do not have any authorization for this command.",
